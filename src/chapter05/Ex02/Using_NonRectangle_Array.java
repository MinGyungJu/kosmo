...
public class Using_NonRectangle_Array {
	...
	public static void main(String[] args) {
		...
		arr1[1] = new int[3];	//1번쨰 행의 열의 3개를 갯수를 지정
		arr1[1][0] = 3;
		arr1[1][1] = 4;
		arr1[1][2] = 5;
		...
		int [][] arr2 = new int [2][];	//비정방형 배열 선언 : 형의 갯수만 먼저 선언, 열은 선언하지 않음
		arr2[0] = new int[] {1,2};		//0번쨰 행의 값을 바로 할당. (주의 : 방크기를 지정하면 오류)
		arr2[1] = new int[] {3,4,5};	//1번쨰 행의 값을 바로 할당.
