...
public class TypeCasting_2 {
	...
	public static void main(String[] args) {
		...
		float value3 = 3.5F + 5.0F;
		double value4 = 8.0 /5.0;
		
		//byte, short 을 연살을 하면 정수(int)로 처리해야됨.
		byte data1 = 3;
		byte data2 = 5;
		...
		//다른 자료형 간의 연산  ( 작은 자료형이 큰 자료형으로 자동으로 업캐스팅되어연산됨)
		
		//int value6 = 5 + 3.5;		// 오류발생
		int value6 = (int)(5+3.5);			// int로 다운캐스팅
		
		double value7 = 5 + 3.5;			// 5가 double로 자동으로 업캐스팅됨
