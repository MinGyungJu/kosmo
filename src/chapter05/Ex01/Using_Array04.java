...
public class Using_Array04 {
	...
	public static void main(String[] args) {
		...
		// 		- 참조 자료형 : 변수는 Stack 에 저장 , 값은 Heap에 저장.
		//			변수의 Heap 영역의 주소값이 들어있다.
		// 		- 기본 자료형 : 변수와 값이 모두 Stack에 저장되어 있다.
		...
		// 2. 방의 갯수를 변경할 수 없다. (정적이다)
			...
			//	-  참조자료형일경우 : null	<== 0이 아닌 비어있는 상태
		
		// 1.배열 선언과 초기화
		int[]a = new int[5];
			// int 배열 변수 ([]) a 생성
			// new : Heap 공간에 int 배열방 5개를 생성해서 Heap 주소를 a변수에 할당
		...
		System.out.println(a[0]);	// index (방번호) 
