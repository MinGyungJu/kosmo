...
public class Using_Method03 {
	...
	public static void main(String[] args) {
		// main 메소드도 method 이다.
		int a ;		// 지역변수이다. <== Stack 에 저장, Stack 영역을 강제 초기화가 안됨
							//Stack에 값이 저장, main () 메소드 내에서만 사용됨.
		a= 10;
		
		System.out.println(a);	//초기값을 넣지 않고 출력시 오류발생
		...
		//	static 메소드 내에서는 static 필드나, static 메소를 사용 할 수있다.
