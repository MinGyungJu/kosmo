...
public class Using_Break {
	...
	public static void main(String[] args) {
		...
		//		- 1단계만 탈출
		// for, while, do while (반복문을 탈출 할때 사용)
		...
		//break는 for, while, do while 내에서 if조건문과 같이 사용
		for ( int i = 0; i<10 ; i++) {
			System.out.println(i);
		...
		//	case2. 한꺼번에 탈출 ( 바깥쪽 for 문의 변수의 값을 조건이 false가 나도록 증가시켜서
		System.out.println("=============================================");
		for (int i = 0; i<5; i++) {					// 0~4 : 5번 loop
			for (int j=0; j<5 ; j++) {				// 0~4 : 5번 loop
				if (j==2) {
		...
		// case 2.2 한꺼번에 탈출 (lable 사용해서 탈출)
