...
public class Using_Polymorphism01_2 {
	...
	public static void main(String[] args) {
		...
		//2. Person 객체 생성
			...
			// Animal 타입의 필드, 메소드만 접근가능, Person타입으로 다운캐스팅 가능
		...
		System.out.println(p1.persnonName);
		
		//3. Person 객체를 Person 타입으로 생성 (Animal, Person)
		Person p2 = new Person();
		System.out.println(p2.name);
		System.out.println(p2.persnonName);
		...
		System.out.println(p3.persnonName);
		
		//4. Person_person 객체를 Animal 타입으로 생성
			// a4는 Animal, Person, Person_person 타입을 모두 내포하고 있고 Animal타입으로 지정
