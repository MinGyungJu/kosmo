...
{	
	...
	public void registVideo(){
		...
		//(1) 화면의 사용자 입력값 얻어오기
		String vno = (String)comVideoJanre.getSelectedItem();
		String janre = (String)tfVideoTitle.getText();
		String title = (String)tfVideoTitle.getText();
		String director = (String)tfVideoDirector.getText();
		String actor = (String)tfVideoActor.getText();
		String v_desc = (String)taVideoContent.getText();
	...
	public void modifyVideo(){
		...
		//vo.setGenre(comVideoJanre.getSelectedItem());
		//comVideoJanre.setSelectedItem(vo.getGenre());
