...
// class 외부에 올 수 있는것(3가지) : 패키지, 임포트(같은 패키지에 존재하지 않는 클래스), 외부클래스

class A { 	//클래스 : 객체를 생성하기 위한 설계도
	// 클래스 내부에 올 수 있는것(4가지) : 1. 필드(클래스에서 선언된 변수), 2. 생성자 , 3.메소드, 4.이너클래스
	// 1. 필드
...
public class Using_Object {
	...
	public static void main(String[] args) {
		...
		double d=a1.work3(10, 20, "오늘");	// 리턴받은 값을 변수에 할당 후 출력
