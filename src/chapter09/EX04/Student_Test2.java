...
class Student03{
	...
	private static int serialNum = 1000;	//모든 객체에서 공유하는 필드, 객체를 생성할때마다 1씩 증가시킴
	private int studentID;					//학생 공유ID
	private String studentName;				//학생 이름
	private int grade;						//학년 : 기본값으로 4 ( 1 ~ 4)
	...
	public void setGrade(int grade) {		//setter : grade 필드의 값을 할당하는 setter
		...
		this.grade = grade;
			...
			System.out.println("잘못된 값을 입력 했습니다. 1~4까지만 입력하세요");
			return;		//메소드 종료
	}
}
	public void setMonth(int month) {	//외부 클래스에서 접근 가능
		...
		this.month=month;
			...
			System.out.println("잘못된 값을 입력 했습니다. 1~12까지만 입력하세요");
			return;		//메소드 종료
		}
	}
}
